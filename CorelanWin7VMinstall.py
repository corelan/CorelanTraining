...
def create_wpy2_bat_files(windbg_root):
    ...
    content_x86 = (
        ...
        "\r\n"
        "set \"WINDBG_CMD=windbg.exe -hd -c '!load pykd.pyd;as mona !py -2 --global mona.py' \"\r\n"
        "\r\n"
        "%WINDBG_CMD% %*\r\n"
        "\r\n"
        "set PATH=%ORIGPATH%\r\n"
    ...
    content_x64 = (
        ...
        "\r\n"
        "set \"WINDBG_CMD=windbg.exe -hd -c '!load pykd;as mona !py -2 --global mona.py' \"\r\n"
        "\r\n"
        "%WINDBG_CMD% %*\r\n"
        "\r\n"
        "set PATH=%ORIGPATH%\r\n"
...
def create_wpy3_bat_files(windbg_root):
    ...
    content_x86 = (
        ...
        "\r\n"
        "set \"WINDBG_CMD=windbg.exe -hd -c '!load pykd;as mona !py -3 --global mona.py' \"\r\n"
        "\r\n"
        "%WINDBG_CMD% %*\r\n"
        "\r\n"
        "set PATH=%ORIGPATH%\r\n"
